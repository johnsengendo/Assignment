...
class LinearTopology(Topo):
    def __init__(self, hosts, switches, bandwidth='10mbps'):
        ...
        # Storing the links for later use
        self.links = [(hosts[0], switches[0]), (switches[0], switches[1]), (switches[1], hosts[1])]

    def set_link_bandwidth(self, link, bandwidth):
        # Setting the bandwidth of a given link
        self.getLink(*link).config(bw=bandwidth)
